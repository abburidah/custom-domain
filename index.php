   ...
   <head>
    ...
    <style amp-custom>
        *{box-sizing:border-box;margin:0;padding:0}:focus{outline:0}::-webkit-scrollbar{display:none}a,a:after,a:hover,a:visited{text-decoration:none;color:#fff}
        ...
        .kiw-kiw a.btn1{
            color:#ffffff;
            background-image:linear-gradient(-45deg,#cc8b00 0,rgb(255, 94, 0) 100%);
            box-shadow:none;
            font-weight:700
            }
        .imghero{
        ...
        .bvs-container{
            display:flex;
            background:linear-gradient(-45deg,#dd5b04 0,rgb(255, 60, 0) 100%);
            margin-bottom:10px;
            width:100%;
            height:40px;
            align-items:center;
        ...
        .btn2{
            ...
            background-image:linear-gradient(#212121,#212121),linear-gradient(137.48deg,#d3a042 10%,#f19408 45%,#ad5809 67%,#b12828 87%);
        ...
        @keyframes animStar{
            from{transform:translateY(0)}to{transform:translateY(-135rem)}
        }
        @keyframes animStarRotate{
            from{transform:rotate(360deg)}to{transform:rotate(0)}
        }
        @keyframes gradient_301{
            0%{background-position:0 50%}50%{background-position:100% 50%}100%{background-position:0 50%}}@keyframes pulse_3011{0%{transform:scale(.75);box-shadow:0 0 0 0 rgba(0,0,0,.7)}70%{transform:scale(1);box-shadow:0 0 0 10px transparent}100%{transform:scale(.75);box-shadow:0 0 0 0 transparent}
        }
        </style>
   </head>
<body>
    <header class="headerbar">
		<div class="header-logo">
			<center><amp-img class="home-button" src="12.png" width="100" height="100"></amp-img></center>
		</div>
	</header>
   <main>
      <div class=cekurukuk>
        <div class=pokjeruk>
          ...
          <div class=kiw-kiw>
            ...
            <a href='https://cutt.ly/Tunnel3' target=_blank rel="noopener noreferrer nofollow" class="btn1 contole" id="dua">LIVE CHAT</a>
           
            <a href='https://cutt.ly/Tunnel3' target=_blank rel="noopener noreferrer nofollow" class="btn1 contole">LINK GACOR</a>
          </div>
        </div>
